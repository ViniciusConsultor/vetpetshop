...
<body>
    <form id="form1" runat="server">
        ...
        <center>
            ...
            <span style="display:block;"><asp:RequiredFieldValidator ValidationGroup="login" ID="rfvtxtUsu" ControlToValidate="txtUsu" runat="server" ErrorMessage="Preencha o campo Login" Display="Dynamic"></asp:RequiredFieldValidator></span>
            <span style="display:block;"><asp:RegularExpressionValidator ValidationGroup="login" ID="revtxtUsu" runat="server" ControlToValidate="txtUsu" ErrorMessage="Campo Login deve conter no mínimo 4 e máximo 30 caracteres" ValidationExpression="^[\s\S]{4,30}$" Display="Dynamic"></asp:RegularExpressionValidator></span>
            <span style="display:block;"><asp:RequiredFieldValidator ValidationGroup="login" ID="rfvtxtSenhaUsu"  ControlToValidate="txtSenhaUsu" runat="server" ErrorMessage="Preencha o campo Senha" Display="Dynamic"></asp:RequiredFieldValidator></span>
            <span style="display:block;"><asp:RegularExpressionValidator ValidationGroup="login" ID="revtxtSenhaUsu" runat="server" ControlToValidate="txtSenhaUsu" ErrorMessage="Campo Senha deve conter no mínimo 4 e no máximo 20 caracteres" ValidationExpression="^[\s\S]{4,20}$" Display="Dynamic"></asp:RegularExpressionValidator></span>
        </center>
        </div>
        <div style="width:98%; margin: 1% 0 0 0;">
            ...
            <ul>
                ...
                <li style="margin-bottom:20px; list-style:none;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnOk" runat="server" Text="Entrar" onclick="Button1_Click" Width="15%" ValidationGroup="login"/>    
                </li>
            </ul>
            </center>
        </div>
            ...
            <div style="width:98%; margin: 1% 0 0 1%;">
                ...
                <ul>
                    <li style="margin-bottom:5px; list-style:none;">
                        ...
                        <span style="display:block;"><asp:RegularExpressionValidator ValidationGroup="email" ID="revtxtEmailLembraSenha" runat="server" ControlToValidate="txtEmailLembraSenha" ErrorMessage="Campo E-mail inválido" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic" SetFocusOnError="true"></asp:RegularExpressionValidator></span>
                    ...
                    <li style="margin-bottom:15px; list-style:none;">
                        ...
                        <asp:Button ID="btnEnviarLembrete" runat="server" Text="Enviar" Width="5%" onclick="btnEnviarLembrete_Click" ValidationGroup="email"/>    
                    </li>
                 </ul>
                </center>       
            </div>
