...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" Visible="false">                               
        ...
        <div style="width:100%; margin:5px 0 10px 20px;">
            <ul>
    ...
    <div style="width:100%; margin:10px 0 5px 10px;">
    ...
    <div id="divProdutos" runat="server" class="escondido" style="width: 95%; margin: 10px 0 20px 18px;">  
         <asp:GridView ID="grUsuarios" runat="server" AutoGenerateColumns="false" 
            ...
            <HeaderStyle  Width="5%"/>                      
            <ItemTemplate>
            <asp:LinkButton ID="lkExcluir" runat="server" OnClientClick=" return confirm('Deseja realmente excluir este produto?');" Text="Excluir" CommandName="excluir" CommandArgument='<%# Eval("id_produto") %>'></asp:LinkButton>
            </ItemTemplate>
            </asp:TemplateField>                                      
